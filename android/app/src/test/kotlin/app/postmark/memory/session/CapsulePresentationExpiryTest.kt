...
import app.postmark.memory.ui.capsule.DecryptedPhoto
import app.postmark.memory.ui.capsule.GrantGuardedCapsuleContentSource
...
class CapsulePresentationExpiryTest {
    ...
    private class CountingReader : app.postmark.memory.ui.capsule.CapsuleContentReader {
        var touches = 0
