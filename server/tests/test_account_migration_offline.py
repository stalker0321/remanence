...
EXPECTED_UPGRADE_FRAGMENTS = [
    ...
    "ALTER TABLE capsules ADD COLUMN first_opened_at TIMESTAMP WITH TIME ZONE",
    ...
    "ALTER TABLE capsules ADD CONSTRAINT ck_capsules_first_opened_state_shape CHECK",
