...
import postmark.core.recognition.CaptureDecoder
...
class RealStillFingerprintProcessorTest {
    ...
    private fun processor(detector: (IntArray, Int, Int) -> List<postmark.core.recognition.QuadCandidate>) =
    ...
    private fun emptyContours(
        ...
        width: Int,
        height: Int,
    ): List<postmark.core.recognition.QuadCandidate> = emptyList()
