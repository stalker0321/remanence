...
_RECIPIENT_TOMBSTONE_LOCK_PREFIX = b"remanence/capsule-tombstone-lock/v1\x00recipient\x00"
...
def recipient_tombstone_lock_key(recipient_user_id: uuid.UUID) -> int:
    return _lock_key(_RECIPIENT_TOMBSTONE_LOCK_PREFIX + recipient_user_id.bytes)
