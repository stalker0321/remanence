...
The imminent SIFT/RootSIFT integrated-test sequence is:

```text
0.2.0-sift-it.1  →  0.2.0-rc.1  →  0.2.0
```
...
`versionCode`. The current historical preview consumed code 11; the first
SIFT candidate consumes code 12. A consumed code is never reused, including
...
`v0.2.0-sift-it.1`, `v0.2.0-rc.1`, and `v0.2.0`. Tags point to the exact clean
