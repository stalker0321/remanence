...
```text
0.2.0-sift-it.1  →  0.2.0-sift-it.2  →  0.2.0-rc.1  →  0.2.0
```
...
consumed codes 12 and 13 in order. A consumed code is never reused, including
...
`v0.2.0-sift-it.1`, `v0.2.0-sift-it.2`, `v0.2.0-rc.1`, and `v0.2.0`. Tags point to the exact clean
