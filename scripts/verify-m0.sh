...
[[ "${alembic_version}" == "0005_m2_f3_capsule_revocation" ]] || die "alembic_version is not 0005_m2_f3_capsule_revocation"
...
log "healthz {\"status\":\"ok\"}; alembic 0005_m2_f3_capsule_revocation; blob probe mode 0600"
