...
| M2-A11c | A11b | Adopt the A11b verified control/index result and recognition ciphertext atomically into account-scoped local state. | crash-safe adoption/state-CAS and no-plaintext-persistence tests |
