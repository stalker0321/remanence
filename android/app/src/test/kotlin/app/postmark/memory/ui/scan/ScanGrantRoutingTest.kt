...
import app.postmark.memory.identity.DirectorySenderKeyStore
import app.postmark.memory.session.RootViewModel
import app.postmark.memory.session.SessionState
import app.postmark.memory.session.SessionStateResolver
...
class ScanGrantRoutingTest {
    ...
    fun factoryWiringGivesBothViewModelsTheContainerGrantManager() = runBlocking {
        ...
        val factory = PostmarkViewModelFactory(container)
