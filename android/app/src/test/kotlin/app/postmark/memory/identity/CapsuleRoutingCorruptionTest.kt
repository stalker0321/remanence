...
import app.postmark.memory.ui.scan.ScanMatchUiState
...
class CapsuleRoutingCorruptionTest {
    ...
    fun setUp() {
        ...
        database = Room.databaseBuilder(context, PostmarkLocalDatabase::class.java, "routing-corruption.db")
    ...
    fun wellFormedButWrongAlgorithmOrSecretKeysetFailsClosed() {
        ...
        val secretAes = TinkProtoKeysetFormat.serializeKeyset(
            postmark.core.crypto.CapsuleKeysetGenerator().generate(),
