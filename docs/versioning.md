...
```text
0.2.0-sift-it.1  →  0.2.0-sift-it.2  →  0.2.0-sift-it.3  →  0.2.0-sift-it.4  →  0.2.0-sift-it.5  →  0.2.0-sift-it.6  →  0.2.0-sift-it.7  →  0.2.0-rc.1  →  0.2.0
```
...
consumed codes 12, 13, 14, 15, 16, 17, and 18 in order. A consumed code is never reused, including
...
`v0.2.0-sift-it.4`, `v0.2.0-sift-it.5`, `v0.2.0-sift-it.6`, `v0.2.0-sift-it.7`, `v0.2.0-rc.1`, and `v0.2.0`. Tags point to the exact clean
