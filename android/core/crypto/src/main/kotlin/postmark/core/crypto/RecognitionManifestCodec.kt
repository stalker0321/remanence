...
import app.postmark.protocol.v1.ChooserHint
import app.postmark.protocol.v1.RecognitionManifest
...
class RecognitionManifestCodec {
    ...
    data class RoutingContext(
        val capsuleId: postmark.core.model.CapsuleId,
        val blobId: postmark.core.model.BlobId,
        val senderUserId: postmark.core.model.UserId,
        val recipientUserId: postmark.core.model.UserId,
    ) {
