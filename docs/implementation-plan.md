...
| M2-A11c2 | A11c1 | Adopt the A11b verified control/index result and recognition ciphertext atomically into account-scoped Room state. | durable file adoption followed by owner/CAS blob CACHED and capsule INDEX_CACHED tests |
