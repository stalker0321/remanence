...
[[ "${alembic_version}" == "0004_r1_publication_order" ]] || die "alembic_version is not 0004_r1_publication_order"
...
log "healthz {\"status\":\"ok\"}; alembic 0004_r1_publication_order; blob probe mode 0600"
